package com.nicoqueijo.android.instagramclone.dialogs;
...
public class ConfirmPasswordDialog extends DialogFragment {
    ...
    private static final String TAG = ConfirmPasswordDialog.class.getSimpleName();
        ...
        confirmDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!password.equals("")) {
                    ...
                    Toast.makeText(getActivity(), "You must enter a a password.", Toast.LENGTH_SHORT).show();
                }
            }
        });
